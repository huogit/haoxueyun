...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //微服务路路径，子模块
        String childrenModel = "/service/service_ucenter";
        // 全局配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/edu_ucenter?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("edu_ucenter");
