...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //模块名字
        String modelName = "acl";
        //微服务路路径，当前模块
        String childrenModel = "/service/service_acl";
        // 全局配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/edu_acl?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
...
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                return projectPath + "/src/main/java/com/prestrive/com/service/"+ modelName +"/mapper/xml/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
