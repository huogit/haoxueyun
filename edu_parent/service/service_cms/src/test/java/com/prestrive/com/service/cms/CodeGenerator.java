package com.prestrive.com.service.cms;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //模块名字
        String modelName = "cms";
        //微服务路路径，子模块
        String childrenModel = "/service/service_cms";
        // 全局配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/edu_cms?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("edu_cms");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                // 生成mapper配置 com/prestrive/com/service/cms/mapper/xml/
//                return projectPath + "/src/main/resources/mapper/" + pc.getModuleName()
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                return projectPath + "/src/main/java/com/prestrive/com/service/cms/mapper/xml/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
