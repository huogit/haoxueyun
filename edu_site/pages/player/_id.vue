...
export default {
  async asyncData(page) {
    console.log('page', page.route.params.id)
    const videoSourceId = page.route.params.id
    console.log(videoSourceId)
    const response = await courseApi.getPlayAuth(videoSourceId)
  ...
  mounted() {
    ...
    console.log('videoSourceId', this.videoSourceId)
